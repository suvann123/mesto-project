...
export const deletePicturePopup = document.querySelector('.popup_type_delete-picture');
...
export const avatarSubmitButton= document.querySelector("#submitEditAvatarButton");
export const avatarLinkInput= document.querySelector("#avatarlink");
export const addCardSubmitButton = document.querySelector('.form__button_type_submit-picture-adding');
export const galleryTemplate = document.querySelector("#gallery__element").content;